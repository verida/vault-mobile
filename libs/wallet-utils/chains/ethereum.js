...
var utils = /** @class */ (function () {
    ...
    utils.createWallet = function () {
        ...
        return {
            ...
            address: ethers_1.ethers.utils.computeAddress(wallet.privateKey)
        };
    };
    utils.getWallet = function (mnemonic) {
        var wallet = ethers_1.ethers.Wallet.fromMnemonic(mnemonic);
        return {
    ...
    utils.verifySignature = function (message, signature, did, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var address;
            return __generator(this, function (_a) {
                address = utils.recoverAddress(message, signature);
                return [2 /*return*/, (address === null || address === void 0 ? void 0 : address.toLowerCase()) == did.replace('did:ethr:', '').toLowerCase()];
            });
        });
    };
    return utils;
