...
export const EnvVarsSchema = z.object({
  ...
  // Banksia testnet
  VERIDA_BANKSIA_RPC_URL: z.string().url(),
  VERIDA_BANKSIA_NOTIFICATION_SERVER_URL: z.string().url(),
  VERIDA_BANKSIA_DATA_CONNECTOR_URL: z.string().url(),
  VERIDA_BANKSIA_META_TRANSACTION_SERVER_URL: z.string().url(),

  // Myrtle mainnet
  VERIDA_MYRTLE_RPC_URL: z.string().url(),
  VERIDA_MYRTLE_NOTIFICATION_SERVER_URL: z.string().url(),
  VERIDA_MYRTLE_DATA_CONNECTOR_URL: z.string().url(),
  VERIDA_MYRTLE_META_TRANSACTION_SERVER_URL: z.string().url(),
