/**
 * Credit @craftzdog https://github.com/craftzdog/react-native-checkbox-reanimated
 * Note: This little animation component style is not flexible, and hard to style follow design requirements, so I put it here for styling it easily.
 */
