...
import { nearWallet } from './NearWalletUtil'
...
export async function approveNearRequest(
  ...
  switch (request.method) {
        ...
        transactions: [
          {
            ...
            actions:
              params.request.params.transaction.actions.map(createAction),
          },
        ],
      })
    ...
    default:
      throw new Error('Unknown JSON-RPC Method Requested')
  }
}

export function rejectNearRequest(
