 ...
 */
export const navigationLinkingConfiguration: LinkingOptions<MainStackParams> = {
  ...
  config: {
    screens: {
      ...
      Inbox: 'inbox', // TODO: Double check if related to notification and whether it should be handled by a protocol handler. On the other hand, It can be usefull to have a navigtion link to the inbox. Check if any conflict if both are defined.
    },
  },
}
