...
const list = [
    { label: 'Afternoon Run', icon: <StravaSvg />, date: '11/10/2018', distance: { value: 6.42, unitOfMeasure: 'ml' }, calories: 737 },
    { label: 'Cycling', icon: <StravaSvg />, date: '09/10/2018', distance: { value: 281.4, unitOfMeasure: 'km' }, calories: 1203 },
];
