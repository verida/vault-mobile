...
export interface AddSocialNetworkLinkScreenProps {
  screenName: string
  title?: string
  label?: string
  url?: string
...
const AddSocialNetworkLink = () => {
  const navigation = useNavigation()
  const params = useParams<AddSocialNetworkLinkScreenProps>()
  const {
    screenName,
    title,
    label,
...
export default AddSocialNetworkLink
